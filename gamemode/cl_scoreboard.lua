...
function Scoreboard:Open()
    ...
    dossier.Paint = function(_, width, height)
        ...
        draw.SimpleText(string.format("LEVEL %03d / %03d  //  %s", playerEntity:GetNWInt("Level", 1), playerEntity:GetNWInt("MaxLevel", 1), playerEntity:IsBot() and "BOT" or "SURVIVOR"), "ZM_ScoreboardValue", 140, 73, palette.muted, TEXT_ALIGN_LEFT, TEXT_ALIGN_TOP)
        surface.SetDrawColor(palette.black)
    ...
    allyButton:SetTooltip("Local relationship marker. Player alliance requests can replace this action later.")
    blockButton:SetTooltip("Local relationship marker. Player blocking can replace this action later.")
